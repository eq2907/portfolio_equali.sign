...
function Portfolio({ title, subtitle, shortDescription, image, associatedImg, associatedName, linkWork, label, imageOrder = 2, textOrder = 1, slug }) {
	...
	return (
		<div className='portfolio-card min-[1024px]:h-[50vh] min-[1200px]:h-[55vh] min-[1400px]:h-[60vh] desktop-xl:h-[60vh] bg-white'>
			<div className='grid grid-cols-1 md:grid-cols-2 min-[1024px]:h-[50vh] min-[1200px]:h-[55vh] min-[1400px]:h-[60vh] desktop-xl:h-[60vh]'>
