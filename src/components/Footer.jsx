	...
	if (platform === 'linkedin') return (
		<svg xmlns='http://www.w3.org/2000/svg' width='22' height='20' viewBox='0 0 21 21' fill='none'>
			<g clipPath='url(#clip-linkedin)'>
				<path fillRule='evenodd' clipRule='evenodd' d='M20.9302 20.9302H16.7442V13.6057C16.7442 11.5964 15.8578 10.4753 14.2681 10.4753C12.5383 10.4753 11.5116 11.6435 11.5116 13.6057V20.9302H7.32558V7.32558H11.5116V8.85549C11.5116 8.85549 12.825 6.55092 15.7845 6.55092C18.7451 6.55092 20.9302 8.35755 20.9302 12.0957V20.9302ZM2.55558 5.14978C1.14384 5.14978 0 3.99659 0 2.57438C0 1.15321 1.14384 0 2.55558 0C3.96628 0 5.11011 1.15321 5.11011 2.57438C5.11116 3.99659 3.96628 5.14978 2.55558 5.14978ZM0 20.9302H5.23256V7.32558H0V20.9302Z' fill='currentColor' />
			</g>
...
const ScrollUpButton = () => (
	<div className='w-14 h-14 mt-10 ml-auto mr-0'>
		<button
			type='button'
		...
		>
			...
			<span className="self-center relative z-10 flex items-center justify-center w-full h-full">
				<svg className='mx-auto' width='20' height='20' viewBox='0 0 20 23' fill='none' xmlns='http://www.w3.org/2000/svg'>
					<path d='M10 21.5714V1M1 10L10 1L19 10' stroke='currentColor' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
				</svg>
			</span>
		</button>
	</div>
