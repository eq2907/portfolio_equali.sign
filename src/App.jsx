			...
			<section className='get-in-touch-wrapper'>
				<div className='grid grid-cols-2 gap-6'>
					<div className='text-center self-center'>
						...
						<p className='font-hanken font-normal text-xl leading-[1.8] mb-6 max-w-[510px] mx-auto'>
					...
					<div className='bg-[#E86F63] p-20'>
						<form className='grid grid-cols-12 gap-4' action="" method="post">
							...
							<div className='col-span-12'>
								<button className='btn-white-solid text-base w-full justify-center inline-flex items-center gap-x-3 mt-2 font-semibold uppercase px-6 pt-[15px] pb-4' type="submit">Send Message</button>
							</div>
						</form>
					</div>
				</div>
		...
		<>
			<footer className='bg-[#181009] text-center'>
				<div className='container mx-auto py-20'>
					...
					<ul className='flex gap-3 mt-6 justify-center [&_a]:border [&_a]:border-white [&_a]:inline-flex [&_a]:justify-center [&_a]:rounded-full [&_a]:px-4 [&_a]:py-4'>
						<li>
							<a href='#'>
								<svg xmlns="http://www.w3.org/2000/svg" width="22" height="20" viewBox="0 0 21 21" fill="none">
									<g clip-path="url(#clip0_38_17)">
										<path fill-rule="evenodd" clip-rule="evenodd" d="M20.9302 20.9302H16.7442V13.6057C16.7442 11.5964 15.8578 10.4753 14.2681 10.4753C12.5383 10.4753 11.5116 11.6435 11.5116 13.6057V20.9302H7.32558V7.32558H11.5116V8.85549C11.5116 8.85549 12.825 6.55092 15.7845 6.55092C18.7451 6.55092 20.9302 8.35755 20.9302 12.0957V20.9302ZM2.55558 5.14978C1.14384 5.14978 0 3.99659 0 2.57438C0 1.15321 1.14384 0 2.55558 0C3.96628 0 5.11011 1.15321 5.11011 2.57438C5.11116 3.99659 3.96628 5.14978 2.55558 5.14978ZM0 20.9302H5.23256V7.32558H0V20.9302Z" fill="white" />
									</g>
									<defs>
						...
						<li>
							<a href='#'>
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 19" fill="none">
									<path d="M2 3.00007L9.75 9.2C11.0834 10.2667 12.9166 10.2667 14.25 9.2L22 3" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
									<path d="M20.5556 1H3.44444C2.09441 1 1 2.08731 1 3.42857V15.5714C1 16.9127 2.09441 18 3.44444 18H20.5556C21.9056 18 23 16.9127 23 15.5714V3.42857C23 2.08731 21.9056 1 20.5556 1Z" stroke="white" stroke-width="2" stroke-linecap="round" />
								</svg>
							</a>
						</li>
					</ul>
